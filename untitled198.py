...
!git clone https://github.com/dtlabs-rd/mc-mot.git
...
# Camera 1
!gdown "https://drive.google.com/uc?id=1sGUnExmJM2_tFuBd9LNlexf0LN2m0_c-" -O epfl/cam1.mp4

# Camera 4
!gdown "https://drive.google.com/uc?id=1sXn70X-bV_YGPv43r4-iMtK_Js09eUVB" -O epfl/cam4.mp4

!ls -lh epfl

# Commented out IPython magic to ensure Python compatibility.
# %%writefile calibrate_colab.py
# import numpy as np
# import cv2
# import argparse
# 
...
!python calibrate_colab.py \
  --video1 epfl/cam1.mp4 \
  --video2 epfl/cam4.mp4 \
  --homography-pth epfl/cam4_H_cam1.npy
...
!python main_colab.py \
  --video1 epfl/cam1.mp4 \
  --video2 epfl/cam4.mp4 \
  --homography epfl/cam4_H_cam1.npy \
  --output epfl/mc_mot_output.mp4 \
  --max-frames 1000

from IPython.display import HTML
from base64 import b64encode

video_path = "epfl/mc_mot_output.mp4"
